...
function ChartContainer({
    ...
    // Extract explicit height from style so ResponsiveContainer gets a fixed px value.
    // recharts ResponsiveContainer requires a parent with a defined pixel height.
    const chartHeight =
        (style as React.CSSProperties & { height?: number | string })?.height ??
        300;
